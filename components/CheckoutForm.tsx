...
export default function EnhancedCheckout() {
  ...
  const totalWithShipping = useMemo(() => {
    return getCartTotal() + (selectedZone?.price || 0) + (orderForm.watch('gift_wrap') ? 5 : 0)
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <Select
                  onValueChange={(value) =>
                    setSelectedZone(
                      shippingZones.find((zone) => zone.id.toString() === value) || null
                    )
                  }
                >
                ...
                {!selectedZone && (
                  <p className="text-red-500 text-sm mt-1">Please select a shipping method</p>
                )}
              </div>
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => orderForm.setValue('gift_wrap', checked as boolean)}
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => orderForm.setValue('newsletter_signup', checked as boolean)}
                />
