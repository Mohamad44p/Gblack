                ...
                {cart.map((item) => (
                  <li key={item.id} className="flex items-center space-x-4 bg-secondary/10 p-4 rounded-lg">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-muted-foreground mt-1">{parseFloat(item.price).toFixed(2)} NIS</p>
                    ...
                    <div className="flex flex-col items-end space-y-2">
                      <span className="font-semibold">{(parseFloat(item.price) * item.quantity).toFixed(2)} NIS</span>
                      {item.size && <p className="text-sm text-muted-foreground">Size: {item.size}</p>}
                      <Button
                        variant="ghost"
                        size="icon"
